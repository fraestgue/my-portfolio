...
function Footer() {
  ...
  return (
    <div className='pie'>
      ...
      <a href="https://github.com/fraestgue" target="blank">{darkTheme === true ? <img src={github1} alt="github" width={"80px"}/> : <img src={github} alt="github" width={"80px"}/> }
      </a>

      <a href="mailto:estepaguerrafrancisco@gmail.com" target="blank">
        <img src={email} alt="email" width={"80px"}/>
      </a>

      <a href="https://www.linkedin.com/in/francisco-estepa-guerra/" target="blank">{darkTheme === true ? <img src={linkedin1} alt="linkedin" width={"80px"}/> : <img src={linkedin} alt="linkedin" width={"80px"}/> }
      </a>
